...
if (action === 'complete') {
  ...
  try {
    taskReport = require("/home/ubuntu/.local/share/code-server/extensions/szlk.solopreneur-roadmap-0.0.471-universal/out/taskReport.js").recordTaskReport(status, args, sequence);
  } catch (error) {
